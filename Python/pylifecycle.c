...
initimport(PyInterpreterState *interp, PyObject *sysmod)
{
     ...
     * Create a module, and bytecode of this module is fixed into a C 
     * array, for example bytecode of '_frozen_importlib' can be seen 
     * in '_Py_M__importlib' in 'importlib.h', and the C array can be 
     * generated by command 'make regen-importlib && make', also the 
     * bytecode in '_Py_M__importlib' comes from '_bootstrap.py'.
     */
                        ...
                        const _PyCoreConfig *core_config)
{
    ...
    *interp_p = interp;
    ...
    /*
     * Ths 'sysmod' is 'sys' in python code, the evidence 
     * is value of 'sysmod' is the same as 'id(sys)'.
     */
    PyObject *sysmod;
    ...
    if (getenv("PYTHON_DEBUG") != NULL) {
      printf("[_Py_InitializeCore_impl] sysmod is 0x%lx\n", (uint64_t)sysmod);
    }
    ...
    /*
     * Install 'sys.modules' to 'sys' module. Explain from python 
     * document is 'This is a dictionary that maps module names to 
