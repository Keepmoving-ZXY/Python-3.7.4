...
abs_srcdir=	/root/Python-3.7.4
abs_builddir=	/root/Python-3.7.4
...
AR=		ar
READELF=	readelf
SOABI=		cpython-37dm-x86_64-linux-gnu
...
BASECPPFLAGS=	
CONFIGURE_CFLAGS=	-O0 -g
# CFLAGS_NODIST is used for building the interpreter and stdlib C extensions.
# Use it when a compiler flag should _not_ be part of the distutils CFLAGS
# once Python is installed (Issue #21121).
CONFIGURE_CFLAGS_NODIST= -std=c99 -Wextra -Wno-unused-result -Wno-unused-parameter -Wno-missing-field-initializers -Wno-cast-function-type -Werror=implicit-function-declaration
...
SHLIB_SUFFIX=	.so
EXT_SUFFIX=	.cpython-37dm-x86_64-linux-gnu.so
...
CONFIG_ARGS=	 '--with-pydebug' '--prefix=/root/.local/' 'CFLAGS=-O0 -g'
...
# This goes into $(exec_prefix)
LIBPL=		$(prefix)/lib/python3.7/config-$(VERSION)$(ABIFLAGS)-x86_64-linux-gnu
